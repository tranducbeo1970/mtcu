...
public class SendContenType {
    ...
    public static void main(String[] args) {
        // sendMessage(22, "CT423MS22");
        // sendMessage(2, "CT423MS2");
        // sendMessage(35, "CT423MS35");
        sendMessage(0, "CT423MS0");
    }

    private static void sendMessage(int contentType, String contentID) {
        ...
        try {
            ...
            x400msg.setIntParam(X400_att.X400_N_CONTENT_TYPE, contentType);
            ...
            System.out.println(BodypartGeneralText.Charset.WEST_EUROPEAN);
