...
public class SendGeneralText {
    ...
    private static void sendMessage() {
        ...
        try {
            x400msg.setTo(recipient_or_address, X400Msg.DR_Request.DR_DELIVERY_REPORT, ipn_request);//DR_NON_DELIVERY_REPORT
            ...
            // x400msg.setStringparam(AMHS_att.ATS_S_TEXT, "ATS_EOH_MODE_LF  SSSSS");
            ...
            body.setStringParam(X400_att.X400_S_BODY_DATA, "PRI: SS\r\nFT: 021312\r\nOHI: SSSSSSSS\r\nATS_EOH_MODE_LF");
