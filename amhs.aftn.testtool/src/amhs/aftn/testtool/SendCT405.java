 ...
 *
 */
public class SendCT405 {

    private static final boolean use_p3 = true;
    private static final boolean send_military_message = false;

    private static final String p3_channel_presentation_address = "\"593\"/URI+0000+URL+itot://andh-pc";
    ...
    private static final String recip = "/CN=IUTAMHAA/OU=IUTA/O=IUT-REGION/PRMD=IUTLAND/ADMD=ICAO/C=XX/";
    ...
    public static void main(String[] args) {
        ...
        extendMode = 0;
        */
        sendIA5Message(session, "CT405MS14", "SS", "200928", "OHI", "");
