 ...
 * @author andh
 */
public class SendMessageFromMTA {
    public static void main(String [] args) {
        ...
        parameter.setOriginator("/OU=VVXXXXXX/O=AFTN/PRMD=VV/ADMD=ICAO/C=XX/");
        parameter.addRecipient(new Address("/OU=VVNBXXXX/O=AFTN/PRMD=VV/ADMD=ICAO/C=XX/"));
