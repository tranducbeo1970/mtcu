...
public class DsapiSample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("initialize api java version:" + DSapi.getJavaDSAPIVersion());
        System.out.println("initialize api version:" + DSapi.getDSAPIVersion());
        ...
        try {
            ...
            System.out.println("initialize Directory Session");
            ds = new DirectorySession("ldap://192.168.1.202:19389");
            
            System.out.println("bind");
            ds.bind(null); // anonymous bind

            System.out.println("Search");
            ind = ds.searchSubTree(new DN("ou=staff,o=big corp"), DirectorySession.MATCHALL, new Selection());          // request all user attributes
