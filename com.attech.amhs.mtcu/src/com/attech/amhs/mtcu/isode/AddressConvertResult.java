...
//        System.out.println(" > item: " + this.address + " time: " + format.format(this.date.getTime()) + " period: " + format.format(periodInMiliSecond) + " current: " + format.format(System.currentTimeMillis()));
    ...
    public String toString() {
        ...
        builder.append("Asyn: ").append(this.verifyAsyncAddress());
