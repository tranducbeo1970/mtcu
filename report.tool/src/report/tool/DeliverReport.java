...
import report.tool.database.MessageConversionLog;
...
//        final TraceInfo config = Config.instance.getAftnChannel().getTraceInfo();
        ...
        String globalDomainId = "/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
        Integer suppliedDomainRoutingAction = 1;
        ...
        set(traceInfo, X400_att.X400_S_GLOBAL_DOMAIN_ID, globalDomainId, -1);
        set(traceInfo, X400_att.X400_S_DSI_ARRIVAL_TIME, arrivalTime, -1);
        set(traceInfo, X400_att.X400_N_DSI_ROUTING_ACTION, suppliedDomainRoutingAction);
    }
